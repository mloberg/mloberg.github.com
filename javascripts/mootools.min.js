...
web build:
 - http://mootools.net/core/aaef762c9239bd9076d66f21b587a52a

packager build:
 - packager build Core/Array Core/String Core/Number Core/Function Core/Object Core/Event Core/Class Core/Class.Extras Core/Element Core/Element.Style Core/Element.Event Core/Request Core/Request.HTML Core/Request.JSON Core/DOMReady
