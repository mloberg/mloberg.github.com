...
category: php
description: Quickly solve version dependency differences in composer.
---
...
check out [my guide for supporting multiple versions of Symfony]({% post_url 2016-01-13-why-static-site-generators %}).
